...
<html>
  ...
  <!-- Facebook and Twitter integration -->
	...
	<link rel="shortcut icon" href="{{ assets('assets/front/favicon.ico')}}">

	<link href="https://fonts.googleapis.com/css?family=Quicksand:300,400,500,700" rel="stylesheet">
	<link href="https://fonts.googleapis.com/css?family=Playfair+Display:400,400i,700" rel="stylesheet">
	
	<!-- Animate.css -->
	<link rel="stylesheet" href="{{ assets('assets/front/css/animate.css')}}">
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="{{ assets('assets/front/css/icomoon.css')}}">
	<!-- Bootstrap  -->
	<link rel="stylesheet" href="{{ assets('assets/front/css/bootstrap.css')}}">
	<!-- Flexslider  -->
	<link rel="stylesheet" href="{{ assets('assets/front/css/flexslider.css')}}">
	<!-- Flaticons  -->
	<link rel="stylesheet" href="{{ assets('assets/front/fonts/flaticon/font/flaticon.css')}}">
	<!-- Owl Carousel -->
	<link rel="stylesheet" href="{{ assets('assets/front/css/owl.carousel.min.css')}}">
	<link rel="stylesheet" href="{{ assets('assets/front/css/owl.theme.default.min.css')}}">
	<!-- Theme style  -->
	<link rel="stylesheet" href="{{ assets('assets/front/css/style.css')}}">

	<!-- Modernizr JS -->
	<script src="{{ assets('assets/front/js/modernizr-2.6.2.min.js')}}"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --> </span> <span>Demo Images: <a href="https://unsplash.com/" target="_blank">Unsplash.com</a></span></small></p>
							...
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
										...
										<p><strong>Hi I'm Rico Tritanto</strong> .</p>
									</div>
								</div>
							</div>
							<div class="row">
	...
	<!-- jQuery -->
	<script src="{{ assets('assets/front/js/jquery.min.js')}}"></script>
	<!-- jQuery Easing -->
	<script src="{{ assets('assets/front/js/jquery.easing.1.3.js')}}"></script>
	<!-- Bootstrap -->
	<script src="{{ assets('assets/front/js/bootstrap.min.js')}}"></script>
	<!-- Waypoints -->
	<script src="{{ assets('assets/front/js/jquery.waypoints.min.js')}}"></script>
	<!-- Flexslider -->
	<script src="{{ assets('assets/front/js/jquery.flexslider-min.js')}}"></script>
	<!-- Owl carousel -->
	<script src="{{ assets('assets/front/js/owl.carousel.min.js')}}"></script>
	<!-- Counters -->
	<script src="{{ assets('assets/front/js/jquery.countTo.js')}}"></script>
	
	
	<!-- MAIN JS -->
	<script src="{{ assets('assets/front/js/main.js')}}"></script>
