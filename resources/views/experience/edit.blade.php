                    ...
                    <div class="card-body">                        
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group" >
                                ...
                                <input type="text" name="firstdate" class="form-control" id='date' value="{{$experience->first_date}}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group" >
                                ...
                                <input type="text" name="lastdate" class="form-control" id='date2' value="{{$experience->last_date}}" required>
                            </div>
                        </div>
                        <div class="form-group">
